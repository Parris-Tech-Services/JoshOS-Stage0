#!/usr/bin/env node
// Inlines the shell into one self-contained HTML file.
// Run: node scripts/build-shell.mjs   ->  dist/josh-os-shell.html
//
// Useful for sharing a build, hosting it, or opening it somewhere the
// relative paths in shell/index.html won't resolve.
