...
> **This repository's role:** this is the cheap product-prototyping and live-ISO environment. Its main contribution is phases 16–17 and product UX experiments that are promoted upstream. It is not the canonical native kernel or firmware repository.
