...
> **Repo focus:** Stage 0 lives almost entirely in the most tractable/observable end of the project. Its job is to prototype desktop/product concepts cheaply; it should not inherit firmware, kernel or hardware-driver complexity merely to make this extraction look more complete.
