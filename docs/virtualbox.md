...
This is the manual acceptance test for the Stage 0 live ISO.
...
The image passes the Stage 0 VirtualBox smoke test when all of these are true:
...
Do not mark the manual VM milestone complete merely because CI produced an ISO.
